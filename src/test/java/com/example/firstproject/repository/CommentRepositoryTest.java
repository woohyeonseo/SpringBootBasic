...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        /*Case 1: 4번 게시글의 모든 댓글 조회*/
        {
            ...
            Long articldId = 4L;
            //2. 실제 데이터
            List<Comment> comments = commentRepository.findByArticleId(articldId);
        ...
        /*Case 4: 999번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected, comments, "999글 자체가 없으므로 댓글은 비어 있어야함");
        }
        /* Case 5 : -1번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(),comments.toString(), "-1번글 자체가 없으므로 댓글은 비어 있어야함");
        }
    }
